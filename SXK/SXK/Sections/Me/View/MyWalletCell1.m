...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _title = [UILabel createLabelWithFrame:VIEWFRAME(15, 0, 150, 53)                                                 andText:@"分享奖励"
                                  andTextColor:[UIColor blackColor]
                                    andBgColor:[UIColor clearColor]
                                       andFont:SYSTEMFONT(13)
                              andTextAlignment:NSTextAlignmentLeft];
        
        _addLabel = [UILabel createLabelWithFrame:VIEWFRAME(15, 0, 150, 53)                                                 andText:@"+600"
        ...
        [_moneyLab mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(_title1.mas_right).offset(0);
            make.centerY.equalTo(_title1);
            make.size.mas_equalTo(CGSizeMake(100, 15));
        }];
