...
@interface MyAppraiseCell ()<PopView1Delegate>

@end

@implementation MyAppraiseCell{
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _content = [UILabel createLabelWithFrame:VIEWFRAME(150, 60, 100, 50)                                                 andText:@"目前状态:检测中"
...
{
    [_popView changeTitle:@"确认完成鉴定?" andIdex:_orderid];
    [_popView show];
