...
@interface MyBussinessCell1 ()<PopView1Delegate>

@end

@implementation MyBussinessCell1{
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _marketPrice = [UILabel createLabelWithFrame:VIEWFRAME(150, 60, 100, 50)                                                 andText:@"预期价:"
                                        andTextColor:[UIColor blackColor]
                                          andBgColor:[UIColor clearColor]
                                             andFont:SYSTEMFONT(12)
                                    andTextAlignment:NSTextAlignmentLeft];
...
-(void)setModel:(id)model
{
    ...
    _price.text = [NSString stringWithFormat:@"¥:%.2f",[_model.advancePrice floatValue] /100];
...
-(void)btnAction:(UIButton *)sender
{
    ...
    [_popView changeTitle2:@"是否删除订单?" andIdex:_rentid type:1];
    [_popView show];
