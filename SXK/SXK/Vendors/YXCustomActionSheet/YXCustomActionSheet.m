...
- (void) showInView:(UIView *)superView contentArray:(NSArray *)contentArray
{
    ...
    for (int i = 0; i < contentArray.count; i++) {
        ...
        btn.frame = CGRectMake(btnX, btnY+30, btnW, btnH);
    ...
    UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, 48, SCREEN_WIDTH, 0.5)];
...
//    [canleBtn setTitle:@"取 消" forState:UIControlStateNormal];
    UIImage *image = [UIImage imageNamed:@"打叉-(2)"];
    [canleBtn setImage:[image imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateNormal];
