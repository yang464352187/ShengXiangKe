...
@interface BrandDetailCell3 ()<UITableViewDelegate, UITableViewDataSource,DFLineCellDelegate,CommentInputViewDelegate>
...
@implementation BrandDetailCell3{
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _tableView = [[UITableView alloc] initWithFrame:VIEWFRAME(0, -40, SCREEN_WIDTH, SCREEN_HIGHT-64) style:UITableViewStyleGrouped];
...
//    _weekSelf(weakSelf);
//    [BaseRequest GetCommentListWithPageNo:1 PageSize:6 order:-1 rentid:[self.rentid integerValue] succesBlock:^(id data) {
...
{
    [self handleModels:array andTotal:6];
}
